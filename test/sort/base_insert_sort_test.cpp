...
TEST(InsertionSort, basic_1_int_increase) {
    std::vector a = {1, 2, 9, 7, 0, 12, 4, 5};
    insertion_sort::sort(a, [](int a, int b) { return a < b; });
...
TEST(InsertionSort, basic_1_int_decrease) {
    std::vector a = {1, 2, 9, 7, 0, 12, 4, 5};
    insertion_sort::sort(a, [](int a, int b) { return a > b; });
...
TEST(InsertionSort, basic_1_double_increase) {
    std::vector a{1.1, 2.8, 9.0, 7.4, 0.002, 12.1, 4.9, 5.32};
    insertion_sort::sort(a, [](double a, double b) { return a < b; });
...
TEST(InsertionSort, basic_1_double_decrease) {
    std::vector a = {1.1, 2.8, 9.0, 7.4, 0.002, 12.1, 4.9, 5.32};
    insertion_sort::sort(a, [](double a, double b) { return a > b; });
...
TEST(InsertionSort, basic_2_int_increase) {
...
TEST(InsertionSort, basic_2_int_decrease) {
    std::vector a = {31, 41, 56, 26, 41, 58};
    insertion_sort::sort(a, [](int a, int b) { return a > b; });
